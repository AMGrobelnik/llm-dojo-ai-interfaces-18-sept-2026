...
|--------|--------|---------|
| **Authority & Credibility** | 40% | Branded over third-party |
| **Content Quality/Utility** | 35% | Clear structure, full answers |
...
| Metric | Impact |
|--------|--------|
| **Referring Domains** | Strongest predictor: >350K = 8.4 citations |
| **Domain Trust Score** | 91-96 = 6 citations; 97-100 = 8.4 |
| **Content Recency** | 30-day old content gets 3.2x more citations |
| **Branded vs Third-party** | Branded cited 11.1 points higher |
...
| Factor | Relevance |
|--------|-----------|
| **Content-Answer Fit** | 55% - top factor; match ChatGPT's style |
...
| Factor | Details |
|--------|---------|
| **Authoritative Domain Lists** | Inherent boost |
| **Freshness Signals** | Time decay; new content evaluated fast |
| **Semantic Relevance** | Similarity to query, not keywords |
| **Topical Weighting** | Tech, AI, Science: visibility multiplier |
| **User Engagement** | Click rates, weekly performance metrics |
| **New Post Performance** | Early clicks strongly boost visibility |

The authoritative-domain lists are curated by hand: Amazon, GitHub and
academic sites carry an inherent boost.
...
| **Content Velocity** | Publishing speed beats keyword density |
| **Semantic Payloads** | Clear, atomic paragraphs preferred |
| **YouTube Sync** | Titles matching trending queries get a boost |
...
| **Authoritative Citations** | +132% visibility, trusted sources |
...
| Rank | Factor | Details |
|------|--------|---------|
| 1 | **Backlinks** | Quality referring domains (core ranking) |
