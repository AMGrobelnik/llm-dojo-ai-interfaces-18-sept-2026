...
- **TechnicalSEO.com** — `technicalseo.com/tools/schema-markup-generator`
  Multiple schema types, validation.
- **Rank Ranger** — `rankranger.com/schema-markup-generator`
  FAQ, Article, Product schemas.
- **Merkle** — `technicalseo.com/tools/schema-markup-generator`
...
- **SEOmator** — `seomator.com/free-seo-audit-tool`
  Comprehensive free audit.
- **Screaming Frog (Free)** — `screamingfrog.co.uk`
...
- **Search Console API** — indexing status, search data.
  `developers.google.com/webmaster-tools`
- **PageSpeed API** — Core Web Vitals data.
  `developers.google.com/speed/docs/insights/v5/get-started`
- **Indexing API** — request indexing.
  `developers.google.com/search/apis/indexing-api`
- **Custom Search API** — programmatic search.
...
| **SEO Review Tools API** | Various checks | Free tier available |

### Schema/Metadata APIs

| API | Purpose | Pricing |
|-----|---------|---------|
| **Apify Metadata Extractor** | Meta, sitemap, robots | $12/mo+ |
...
- **Google SEO Guide** (official) — `developers.google.com/search/docs`
- **Moz Beginner's Guide** (tutorial) — `moz.com/beginners-guide-to-seo`
- **Backlinko** (advanced) — `backlinko.com/hub/seo`
- **Search Engine Journal** (news) — `searchenginejournal.com`

### GEO Research

- **Princeton GEO Paper** (research) — `arxiv.org/abs/2311.09735`
- **GEO Guide, SingleGrain** (guide) — `singlegrain.com/geo`
- **AI Search Optimization, Semrush** (tutorial) —
  `semrush.com/blog/ai-search-optimization`
